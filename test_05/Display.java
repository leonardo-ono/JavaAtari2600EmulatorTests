...
public class Display extends Canvas implements KeyListener, Runnable {
    ...
    public static int romFileSize = 0;
    ...
    private void loadRom(String res) {
        ...
        //InputStream is = getClass().getResourceAsStream(res);
            ...
            if (romFileSize <= 4096) {
                ...
                int romIndex = 0;
                while ((c = is.read()) >= 0) {
                    Cartridge.rom[0xf000 + (4096 - romFileSize) + romIndex] = c;
            ...
            if (romFileSize == 8192) {
                ...
                Bus.writePost(0x1ff9, 1); // start with bank 1 ?
            }
        }
        catch (Exception e) {
    ...
    public void start(String romfile) {
        if (mainThread == null) {
            ...
            // set entry point
            Cpu.RPC = Bus.read(0xfffc) + (Bus.read(0xfffd) << 8);
    ...
    public void keyPressed(KeyEvent e) {
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_1 -> Pia.SWCHB = Pia.SWCHB & 0b11111110; // reset
            case KeyEvent.VK_2 -> Pia.SWCHB = Pia.SWCHB & 0b11111101; // difficulty

            //case KeyEvent.VK_3 -> Pia.SWCHB = Pia.SWCHB | 0b01111111; // not used
    ...
    public void keyReleased(KeyEvent e) {
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_1 -> Pia.SWCHB = Pia.SWCHB | 0b00000001; // reset
            case KeyEvent.VK_2 -> Pia.SWCHB = Pia.SWCHB | 0b00000010; // difficulty

            case KeyEvent.VK_4 -> { // bw or color
                Pia.SWCHB = Pia.SWCHB ^ 0b00001000;
                System.out.println("toogle bw/color");
            }
