...
public class Tia {
    ...
    public static void process(int pixelCycles) {
        ...
        //System.out.print((targetPixelClock % CRT_WIDTH) + " "); // <------------------ apagar
    ...
    private static void updateCollisionRegisters() {
        if (checkCollision(COLLISION_M0_P1)) CXM0P = CXM0P | 0b10000000;
        if (checkCollision(COLLISION_M0_P0)) CXM0P = CXM0P | 0b01000000;
        if (checkCollision(COLLISION_M1_P1)) CXM1P = CXM1P | 0b10000000;
        if (checkCollision(COLLISION_M1_P0)) CXM1P = CXM1P | 0b01000000;
        if (checkCollision(COLLISION_P0_PF)) CXP0FB = CXP0FB | 0b10000000;
        if (checkCollision(COLLISION_P0_BL)) CXP0FB = CXP0FB | 0b01000000;
        if (checkCollision(COLLISION_M0_PF)) CXM0FB = CXM0FB | 0b10000000;
        if (checkCollision(COLLISION_M0_BL)) CXM0FB = CXM0FB | 0b01000000;
        if (checkCollision(COLLISION_M1_PF)) CXM1FB = CXM1FB | 0b10000000;
        if (checkCollision(COLLISION_M1_BL)) CXM1FB = CXM1FB | 0b01000000;
        if (checkCollision(COLLISION_BL_PF)) CXBLPF = CXBLPF | 0b10000000;
        if (checkCollision(COLLISION_P0_P1)) {
            CXPPMM = CXPPMM | 0b10000000;
        }
        if (checkCollision(COLLISION_M0_M1)) CXPPMM = CXPPMM | 0b01000000;
    }
