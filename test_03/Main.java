...
public class Main {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            JFrame frame = new JFrame("Java Atari Emulator - Test #02");
            ...
            String romFile = "F:/leo_hd_d_backup/atari_2600_dev/writing_an_emulator/java_atari_2600_emulator_test_011_fix_remaining/roms/bitmap.bin";
